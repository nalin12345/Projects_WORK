...
path = r'C:\Users\Nalin\Desktop\intern\d39a6017e86c1c3a6274662de8c39b62.jpg'
...
# Read Database
with open(r'C:\Users\Nalin\Desktop\namedb1.csv.txt', 'r') as f:
    reader = csv.reader(f)
    newlist = list(reader)
newlist = sum(newlist, [])
...
fName =  os.path.basename(path).split('.')[0] + '.json'
